                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div style={{ flex: 1, minWidth: 0 }}>
                                        ...
                                        {/* Row 3 — qty + seller + date */}
                                        <div style={{ display: "flex", alignItems: "center", gap: "var(--space-4)", marginBottom: q.notes ? "var(--space-2)" : 0, flexWrap: "wrap" }}>
                                            <span style={{ fontFamily: "var(--font-body)", fontSize: 12, color: "var(--text-3)" }}>
                                                Qty: <span style={{ fontFamily: "var(--font-mono)", fontWeight: 700, color: "var(--text-2)" }}>{q.qtyNeeded}</span>
                                            </span>
                                            {q.sellerId && (
                                                <span style={{ fontFamily: "var(--font-body)", fontSize: 12, color: "var(--text-3)" }}>
                                                    Seller: <span style={{ fontWeight: 600, color: "var(--text-2)" }}>{q.sellerName}</span>
                                                </span>
                                            )}
